...
- Update monit_exporter to version 0.2.5
...
- Update monit_exporter to version 0.2.4

## 2.0.0 (2025-11-09)

### Changes

- Rename parameter from `monit_exporter_monitor_monit_state` to `monit_exporter_monit_state`
